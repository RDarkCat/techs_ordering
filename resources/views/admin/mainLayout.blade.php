            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('adminPanel.tagsByParent') }}">
                                Тэги
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('adminPanel.itemsIndex') }}">
                                Техника
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('adminPanel.promosIndex') }}">
                                Объявления
                            </a>
                        </li>
                    </ul>
