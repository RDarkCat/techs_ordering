            ...
            <div class="d-flex justify-content-between card-body">
                <div>
                    <div class="form-group">
                        ...
                        <input class="form-item" type="text" id="item-name" v-model="promo.name" value=""/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="item-price_per_hour">Цена за час(руб):</label>
                        <input type="text" id="item-price_per_hour" v-model="promo.price_per_hour" value="{ promo.price_per_hour }"/>
                    </div>
                    <div class="form-group">
                        <label for="item-price_per_day">Цена за день(руб):</label>
                        <input type="text" id="item-price_per_day" v-model="promo.price_per_day" value="{ promo.price_per_day }"/>
                    </div>
                    <div class="form-group">
